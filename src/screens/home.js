...
<span>${r.icon}</span>${esc(label)}</div>
...
<div><div style="font-size:14px;color:${C.sub}">${greet},</div><div style="font-size:24px;font-weight:800;color:${C.ink}">${esc(state.user.name)}</div></div>
